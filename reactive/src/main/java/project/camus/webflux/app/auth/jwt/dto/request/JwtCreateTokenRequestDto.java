package project.camus.webflux.app.auth.jwt.dto.request;
...
import project.camus.webflux.app.auth.jwt.util.JwtRefreshTokenUtil;
...
public class JwtCreateTokenRequestDto {
    ...
    public void validate() {
        ...
        if (JwtRefreshTokenUtil.getRefreshTokens().stream()
            ...
            .findAny().isEmpty()) {
            throw new CamusClientException(new IllegalArgumentException("token"));
        }
    }
}
